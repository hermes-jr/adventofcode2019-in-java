...
class Level07Test {
    ...
    void testSampleProg3() {
        String p = Level07.readResourcesFirstLine(Level07.class, "in3");
        l.parseData(p);
    ...
    void testSampleProg4() {
        String p = Level07.readResourcesFirstLine(Level07.class, "in4");
        l.parseData(p);
    ...
    void testSampleProg5() {
        String p = Level07.readResourcesFirstLine(Level07.class, "in5");
        l.parseData(p);
